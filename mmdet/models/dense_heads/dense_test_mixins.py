...
class BBoxTestMixin(object):
    ...
    def simple_test_rpn(self, x, img_metas, return_rpn_bfnms=False):
        ...
        rpn_outs = self(x, **kwargs)

        # ./models/dense_heads/rpn_head.py
        proposal_list = self.get_bboxes(*rpn_outs, img_metas, return_rpn_bfnms=return_rpn_bfnms)
